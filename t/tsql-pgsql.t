# Test harness for AWITPT::Util::ConvertTSQL::PgSQL
...
my $tsqlc = AWITPT::Util::ConvertTSQL->new("PgSQL",'prefix' => "myprefix_");
...
$tsqlc = AWITPT::Util::ConvertTSQL->new("PgSQL");
...
is($tsqlc->convert('@PRELOAD@'),"SET CONSTRAINTS ALL DEFERRED;","Make sure foreign key checks are disabled with \@PRELOAD\@");
is($tsqlc->convert('@POSTLOAD@'),"SET CONSTRAINTS NOT DEFERRED;","Make sure foreign key checks are enabled with \@POSTLOAD\@");
